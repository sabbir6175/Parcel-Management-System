  ...
  return (
    <div className="h-[500px] w-full rounded-lg overflow-hidden shadow-lg relative">
      <form
        ...
        className="absolute top-4 left-1/2 transform -translate-x-1/2 z-[1000] w-full hover:outline-emerald-400 max-w-md px-4 flex "
      >
        <input
          type="text"
          placeholder="Search district..."
          className="flex-1 py-4  input input-success"
          value={searchText}
